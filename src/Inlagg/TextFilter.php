...
class TextFilter
{
     ...
     * @param string  $filter comma-separated string of filters to use.(ändrad från array)
     *
    ...
    */
    ...
    /**
     * Striping html tags from text (Extrauppgift 1)
     *
     * @param string $text The text that should be formatted.
     *
     * @return string the formatted text.
    ...
    /**
     * Formating text to html-entities (Extrauppgift 2)
     *
     * @param string $text The text that should be formatted.
     *
     * @return string the formatted text.
